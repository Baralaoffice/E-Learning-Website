                ...
                <Card sx={{ boxShadow: 'none !important' }}>
                    ...
                    <Box className={classes.boxcard}>
                        <Box className={classes.box_a}>
                            <SchoolIcon className={classes.box_b} /><Typography className={classes.box_c} >19 Courses</Typography>
                        </Box>
                        <Box className={classes.box_a} >
                            <ManIcon className={classes.box_b} /><Typography className={classes.box_c}>25,599 Students</Typography>
                        </Box>
                        <Box className={classes.box_a} >
